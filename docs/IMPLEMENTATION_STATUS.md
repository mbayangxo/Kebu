...
| Kebu Studio | **IN PROGRESS** | **North star:** `KEBU-STUDIO-CREATE-NORTH-STAR.md`. **Fonts catalog · brand/aesthetic apply to canvas · posters/banners/cards presets** **IMPLEMENTED**. Graphics S16 · Teach me · beats · Video Phase 1 (`075`). **Later:** folders/version · elements pack · live cursors · CapCut-class video · Brand DNA depth |
