...
| Kebu Studio | **IN PROGRESS** | **Music timeline V1–V3** on `/studio/video/[id]`: waveform · scrub · BPM/beats · markers · snap · soundtrack · multi-tracks · trim/fades · Audio Reactive foundation (**V1**); keyframes · transforms · transitions · reactive presets (**V2**); AI commands “every 4 beats / chorus climax” (**V3**). Fonts/brand/posters **IMPLEMENTED**. **Later:** folders/version · elements pack · live cursors · CapCut-complete · Brand DNA depth |
