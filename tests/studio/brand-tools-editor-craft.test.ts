...
describe("Studio brand tools and editor craft",()=>{
 ...
 it("exposes usable tools rather than placeholder app cards",()=>{const s=read("app/components/studio/studio-tools-panel.tsx");expect(s).toContain("Apps & tools");expect(s).toContain('action:"text"');expect(s).toContain('href:"/studio/templates"')});
