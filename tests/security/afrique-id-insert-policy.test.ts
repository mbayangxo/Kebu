...
const migration = readFileSync(
  join(process.cwd(), "supabase/migrations/20260919234857_prevent_afrique_id_self_verification.sql"),
  "utf8",
);

const readPolicyMigration = readFileSync(
  join(process.cwd(), "supabase/migrations/20260919234936_restrict_afrique_id_reads_to_owner.sql"),
  "utf8",
);
