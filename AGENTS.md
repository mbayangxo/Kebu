...
- **Framing:** next-gen **African commerce + website OS** — `docs/product/KEBU-BUILDER-NEXT-GEN.md` · **Product thinking (not visual clone):** `docs/product/KEBU-BUILDER-PRODUCT-THINKING.md` · **Template Intelligence:** `docs/product/KEBU-TEMPLATE-INTELLIGENCE.md` · **Design quality:** `docs/product/KEBU-DESIGN-QUALITY-STANDARD.md` · **Builder interaction/UX standard (read before touching any Builder UI — panels, z-index, save states, density):** `docs/product/KEBU-BUILDER-UX-STANDARD.md` · **Cursor paste:** `docs/product/CURSOR-BUILDER-INSTRUCTION.md` · **Reference dossiers + screenshots:** `docs/reference/` (never assume agent knows Shopify/Spotify/Canva from names).
