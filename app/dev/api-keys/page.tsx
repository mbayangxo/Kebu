...
// Placeholder type — will come from /api/dev/api-keys once schema is in place
type ApiKey = {
  id: string;
  name: string;
  prefix: string;
    ...
    >
      ...
      <div className="flex-1 min-w-0">
        ...
        <p
          ...
          style={{ color: KEBU.muted, letterSpacing: "0.04em" }}
        >
          {apiKey.prefix}••••••••••••••••
        </p>
      </div>
    ...
    >
      <div className="max-w-3xl mx-auto px-5 sm:px-8 lg:px-10 py-8">
          ...
          >
            ...
            >
              {["Key", "Scopes", "Last used", ""].map((h) => (
                <p
                  key={h}
                  className="text-[10px] font-bold uppercase tracking-[0.14em] flex-1"
        ...
        <div className="flex items-center justify-between mt-6 pt-5" style={{ borderTop: `1px solid ${T.border}` }}>
          ...
          <p className="text-[11px]" style={{ color: KEBU.faint }}>
            Kebu API v1
          </p>
        </div>
