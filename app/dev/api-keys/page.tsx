  ...
  return (
    ...
    >
      <div className="flex-1 min-w-0">
        <p className="text-sm font-semibold" style={{ color: D.text }}>{apiKey.name}</p>
        <p className="text-xs mt-0.5 font-mono" style={{ color: D.muted, letterSpacing: "0.04em" }}>
          {apiKey.prefix}••••••••••••••••
        </p>
      </div>
      <div className="hidden sm:flex flex-wrap gap-1 shrink-0">
        ...
        {apiKey.scopes.length > 3 && (
          <span className="text-[10px]" style={{ color: D.faint }}>+{apiKey.scopes.length - 3}</span>
        )}
      </div>
      <p className="shrink-0 text-[11px] w-28 text-right" style={{ color: D.muted }}>
      ...
      <div className="min-h-full" style={{ background: D.bg }}>
        <div className="max-w-3xl mx-auto px-5 sm:px-8 lg:px-10 py-8">
          ...
          <div className="flex items-center justify-between mb-6">
            ...
            <button
              type="button"
              className="inline-flex items-center gap-1.5 rounded-xl px-4 py-2 text-xs font-bold transition-all active:scale-[0.97] opacity-40 cursor-not-allowed"
          ...
          >
            ...
            <div>
              <p className="text-sm font-bold mb-0.5" style={{ color: D.text }}>
          ...
          {MOCK_KEYS.length > 0 ? (
            ...
            >
              ...
              <p className="text-base font-bold mb-1" style={{ color: D.text }}>No API keys yet</p>
              <p className="text-sm mb-2 max-w-xs" style={{ color: D.muted }}>
          ...
          {/* Docs link */}
          <div className="flex items-center justify-between mt-6 pt-5" style={{ borderTop: `1px solid ${D.border}` }}>
