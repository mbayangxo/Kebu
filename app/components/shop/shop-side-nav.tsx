...
export const NAV_GROUPS: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { tab: "orders",       sub: "customer", label: "Customer orders" },
      { tab: "orders",       sub: "company",  label: "Company orders" },
  ...
  },
  {
    ...
    icon: "messages",
    label: "Messages",
    items: [{ tab: "messages", label: "All messages" }],
  },
  {
    id: "money",
    icon: "money",
...
function groupBadge(groupId: string, counts: NavCounts): number {
  switch (groupId) {
    ...
    case "messages": return counts.unreadMessages;
