        ...
        sections: [
          ...
          },
          {
            ...
            props: {
              ...
              subheading: "Les produits les plus aimés — avec leur type de peau et préoccupation recommandés.",
              orderCtaLabel: "Commander",
              promoBanner: {
                text: "Commandez 3 produits → livraison gratuite à Dakar",
                subtext: "Ou abonnez-vous — 10% de réduction automatique",
                background: "#1A1A18",
                color: "#F5E6D3",
                insertAfterIndex: 2,
              },
              items: [
                {
                  name: "Sérum Éclat Vitamine C + Karité",
                  description: "Vitamine C stabilisée 15% + beurre de karité brut. Unifie le teint, estompe taches et hyperpigmentation en 3 semaines. Testé peaux mates et foncées.",
                  priceLabel: "18 500 FCFA",
                  imageUrl: "",
                  whatsappMessage: "Bonjour — je voudrais commander le Sérum Éclat :",
                  isSubscription: true,
                  subscriptionInterval: "monthly",
                  subscriptionDiscount: 10,
                  goodFor: ["Hyperpigmentation / taches", "Teint terne", "Peaux mates et foncées", "Peaux mixtes"],
                  notGoodFor: ["Peaux avec rétinol en prescription", "Peaux très sensibles (test d'abord)"],
                  attributes: [
                    { icon: "🌿", label: "Sans parabènes" },
                    { icon: "✨", label: "Vitamine C 15%" },
                    { icon: "🏭", label: "Formulé à Dakar" },
                  ],
                  crossSells: ["Crème Hydratante Légère", "Gel Nettoyant Doux"],
                },
                {
                  name: "Crème Hydratante Légère — Peau grasse/mixte",
                  description: "Formule sans huile, non-comédogène. Hydratation 24h, fini mat. Spéciale peaux grasses tropicales — résiste à la chaleur et l'humidité.",
                  priceLabel: "14 000 FCFA",
                  imageUrl: "",
                  whatsappMessage: "Bonjour — je voudrais commander la Crème Hydratante Légère :",
                  isSubscription: true,
                  subscriptionInterval: "monthly",
                  subscriptionDiscount: 10,
                  goodFor: ["Peaux grasses", "Peaux mixtes", "Brillance / sébum", "Pores dilatés"],
                  notGoodFor: ["Peaux sèches (préférer la Crème Nuit Riche)", "Peaux avec eczéma sévère"],
                  attributes: [
                    { icon: "🛡️", label: "Non-comédogène" },
                    { icon: "🌡️", label: "Résiste chaleur 40°C" },
                    { icon: "🌿", label: "Sans sulfates" },
                  ],
                  crossSells: ["Sérum Éclat Vitamine C + Karité", "Gel Nettoyant Doux"],
                },
                {
                  name: "Gel Nettoyant Doux — Tous types de peau",
                  description: "Nettoyage sans décapage. PH équilibré, sans SLS. Retire pollution et excès de sébum sans tirailler. La base de toute routine.",
                  priceLabel: "9 500 FCFA",
                  imageUrl: "",
                  whatsappMessage: "Bonjour — je voudrais commander le Gel Nettoyant Doux :",
                  isSubscription: true,
                  subscriptionInterval: "monthly",
                  subscriptionDiscount: 10,
                  goodFor: ["Tous types de peau", "Peau sensible légère", "Usage quotidien matin et soir"],
                  notGoodFor: ["Démaquillage waterproof complet (utiliser huile d'abord)"],
                  attributes: [
                    { icon: "🧪", label: "PH équilibré 5.5" },
                    { icon: "🌿", label: "Sans SLS/SLES" },
                    { icon: "💧", label: "Sans parfum de synthèse" },
                  ],
                  crossSells: ["Sérum Éclat Vitamine C + Karité", "Masque Argile Karité"],
                },
                {
                  name: "Masque Argile Karité — 2×/semaine",
                  description: "Argile blanche purifiante + karité pour ne pas dessécher. Désobstrue les pores, lisse le grain de peau. Résultat visible dès la première utilisation.",
                  priceLabel: "12 000 FCFA",
                  imageUrl: "",
                  whatsappMessage: "Bonjour — je voudrais commander le Masque Argile Karité :",
                  goodFor: ["Pores dilatés", "Points noirs", "Teint terne", "Peaux mixtes à grasses"],
                  notGoodFor: ["Peaux sèches ou déshydratées", "Usage quotidien (max 2× par semaine)"],
                  attributes: [
                    { icon: "🏺", label: "Argile blanche Maroc" },
                    { icon: "🌰", label: "Karité Burkina Faso" },
                    { icon: "⏱️", label: "15 min de pause" },
                  ],
                  crossSells: ["Gel Nettoyant Doux", "Crème Hydratante Légère"],
                },
              ],
            },
          },
