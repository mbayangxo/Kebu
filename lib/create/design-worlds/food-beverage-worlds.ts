        ...
        sections: [
          ...
          },
          {
            ...
            props: {
              ...
              items: [
                {
                  name: "Sauce Yassa Citronné — format familial",
                  description: "La sauce yassa maison en bocal. Oignons caramélisés, citron, moutarde — faite comme à Ziguinchor. Format 400g pour 4–6 personnes.",
                  priceLabel: "2 500 FCFA",
                  imageUrl: "",
                  whatsappMessage: "Bonjour — je voudrais commander la Sauce Yassa Citronné (400g) :",
                  expiryDate: "2025-12-31",
                  batchCode: "YAS-2025-11",
                },
                {
                  name: "Sauce Mafé Arachide",
                  description: "Pâte d'arachide grillée, tomate, ail, gingembre. Prête en 20 min — ajoutez votre viande ou légumes. Format 350g.",
                  priceLabel: "2 200 FCFA",
                  imageUrl: "",
                  whatsappMessage: "Bonjour — je voudrais commander la Sauce Mafé Arachide (350g) :",
                  expiryDate: "2025-11-30",
                  batchCode: "MAF-2025-11",
                },
                {
                  name: "Mélange Thiossane — épices thiéboudienne",
                  description: "Le mélange secret du thiéboudienne dakarois. Tomate séchée, piment doux, nété, guedj (fermenté léger). Sachet 80g.",
                  priceLabel: "1 500 FCFA",
                  imageUrl: "",
                  whatsappMessage: "Bonjour — je voudrais commander le Mélange Thiossane (80g) :",
                  expiryDate: "2026-06-30",
                  batchCode: "THI-2025-10",
                },
                {
                  name: "Poudre de Bissap Bio",
                  description: "Fleurs d'hibiscus séchées et moulues — production Casamance. Riche en vitamine C. Sachet 100g, équivaut à ~2L de jus.",
                  priceLabel: "1 800 FCFA",
                  imageUrl: "",
                  whatsappMessage: "Bonjour — je voudrais commander la Poudre de Bissap Bio (100g) :",
                  expiryDate: "2026-09-30",
                  batchCode: "BIS-2025-09",
                },
              ],
            },
          },
        ...
        sections: [
          ...
          },
          {
            ...
            props: {
              ...
              subheading: "Pressés le matin même. Format 250ml, 500ml et 1L. Frais 3 jours au réfrigérateur.",
              orderCtaLabel: "Commander",
              items: [
                {
                  name: "Bissap Gingembre — 500ml",
                  description: "Hibiscus de Casamance + gingembre de Thiès. Anti-oxydants, anti-inflammatoire. Pressé ce matin. À consommer dans 3 jours.",
                  priceLabel: "1 800 FCFA",
                  imageUrl: "",
                  whatsappMessage: "Bonjour — je voudrais commander le jus Bissap Gingembre 500ml :",
                  expiryDate: "2025-11-15",
                  batchCode: "BG-2025-1112",
                },
                {
                  name: "Mangue Citron Menthe — 500ml",
                  description: "Mangues Kent de Sine Saloum + citron vert + menthe fraîche. Sucré naturellement, zéro sucre ajouté.",
                  priceLabel: "2 000 FCFA",
                  imageUrl: "",
                  whatsappMessage: "Bonjour — je voudrais commander le jus Mangue Citron Menthe 500ml :",
                  expiryDate: "2025-11-15",
                  batchCode: "MCM-2025-1112",
                },
                {
                  name: "Boost Baobab Moringa — 250ml",
                  description: "Shot énergisant : poudre de baobab + moringa frais + pomme + citron. Vitamine C, fer, calcium. Le shot du matin.",
                  priceLabel: "1 500 FCFA",
                  imageUrl: "",
                  whatsappMessage: "Bonjour — je voudrais commander le Boost Baobab Moringa 250ml :",
                  expiryDate: "2025-11-14",
                  batchCode: "BBM-2025-1112",
                },
                {
                  name: "Tamarin Citron Vert — 500ml",
                  description: "Tamarin sénégalais pressé + citron vert + eau de source. Acidulé, rafraîchissant, riche en vitamine C.",
                  priceLabel: "1 800 FCFA",
                  imageUrl: "",
                  whatsappMessage: "Bonjour — je voudrais commander le jus Tamarin Citron Vert 500ml :",
                  expiryDate: "2025-11-15",
                  batchCode: "TC-2025-1112",
                },
              ],
            },
          },
