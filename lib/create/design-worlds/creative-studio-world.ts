        ...
        sections: [
          ...
          },
          {
            ...
            props: {
              ...
              subheading: "MAKING GOOD BRANDS IMPOSSIBLE TO IGNORE.",
              layout: "grid",
              items: [
                {
                  title: "VELVET THEORY — Campagne mode",
                  body: "Direction artistique complète pour la collection capsule automne. Shooting 2 jours, 40 photos livrées. Résultat : +60% engagement Instagram.",
                  imageUrl: "",
                  icon: "MODE",
                  href: "/portfolio",
                },
                {
                  title: "BAOBAB NATURALS — Identité visuelle",
                  body: "Logo, charte couleurs et typographie pour marque cosmétique naturelle dakaroise. Livré en 12 jours ouvrés.",
                  imageUrl: "",
                  icon: "BRANDING",
                  href: "/portfolio",
                },
                {
                  title: "KORA FINANCE — Contenu social",
                  body: "Pack 30 visuels/mois pour startup fintech — photos équipe, infographies, stories. Contrat 6 mois renouvelé.",
                  imageUrl: "",
                  icon: "CONTENU",
                  href: "/portfolio",
                },
                {
                  title: "MAWA DELI — Lancement restaurant",
                  body: "Identité visuelle, menus, shooting plats et ambiance pour restaurant fusion Dakar. Ouverture sold out le premier soir.",
                  imageUrl: "",
                  icon: "FOOD",
                  href: "/portfolio",
                },
