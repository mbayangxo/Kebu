        ...
        sections: [
          ...
          },
          {
            ...
            props: {
              ...
              layout: "grid",
              items: [
                { icon: "🏠", title: "Achat & Vente", body: "Recherche, négociation, acte notarié et remise des clés." },
                { icon: "📋", title: "Estimation", body: "Évaluation précise de votre bien au prix du marché actuel." },
                { icon: "🔑", title: "Location", body: "Mise en location courte et longue durée avec sélection des locataires." },
                { icon: "🛠️", title: "Rénovation", body: "Réseau d'artisans certifiés pour valoriser votre bien avant vente." },
                { icon: "📊", title: "Conseil investissement", body: "Analyse de rentabilité et conseil patrimonial personnalisé." },
                { icon: "⚖️", title: "Suivi juridique", body: "Vérification titres, purge d'hypothèques, accompagnement notaire." },
              ],
            },
          },
          {
            ...
            props: {
              ...
              fields: [
                ...
                { id: "email", label: "Email", type: "email", required: false },
                {
                  ...
                  type: "select",
                  required: true,
                  options: ["Achat", "Vente", "Location", "Gestion locative", "Estimation gratuite", "Conseil investissement"],
                },
                { id: "zone", label: "Zone / quartier souhaité", type: "text", required: false },
                { id: "budget", label: "Budget (FCFA)", type: "text", required: false },
