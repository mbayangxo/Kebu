...
export const sectionPropsSchemas = {
  ...
  hero: z.object({
    ...
    imagePosition: z.string().trim().max(40).optional().default("50% 50%"),
    overlayOpacity: z.number().min(0).max(0.9).optional().default(0.42),
    minHeight: z.enum(["50vh", "70vh", "80vh", "100vh"]).optional().default("80vh"),
    headingFontFamily: z.string().trim().max(120).optional(),
  ...
  text: z.object({
    ...
    headingFontFamily: z.string().trim().max(120).optional(),
    headingFontSizePx: z.number().int().min(12).max(160).optional(),
    bodyFontFamily: z.string().trim().max(120).optional(),
    bodyFontSizePx: z.number().int().min(8).max(96).optional(),
    hidden: z.boolean().optional(),
    deviceOverrides: deviceOverridesSchema,
  }),
  image: z.object({
