...
export const canvasLayerSchema = z.object({
  ...
  fillType: z.enum(["solid", "linear_gradient"]).optional().default("solid"),
  ...
  blendMode: z.enum(["normal","multiply","screen","overlay","darken","lighten","soft-light"]).optional().default("normal"),
